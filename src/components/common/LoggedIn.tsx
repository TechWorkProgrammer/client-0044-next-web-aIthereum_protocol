...
const LoggedInComponent: React.FC<LoggedInComponentProps> = ({
  ...
  const walletIconSrc =
    walletIconMap[user?.walletType || ""] || "/assets/wallets/default.png";
  ...
  const handleUpdateUsername = async () => {
    ...
    try {
      ...
      alert(
        "Update Failed",
        err.message || "Unable to change username.",
        "error"
      );
    } finally {
      loader(false);
      ...
      <div className="flex flex-col items-start justify-start w-full">
        <div className="flex items-center w-full space-x-3">
          <div className="relative">
            ...
            />
            <div className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-accent-300 p-[2px] flex justify-center items-center shadow">
              <Image
                src={walletIconSrc}
        ...
        <div className="w-full border border-secondary-200 rounded-md px-4 py-2 flex items-center justify-between my-6">
          <p className="text-white/70 text-base">Aithereum Points</p>
