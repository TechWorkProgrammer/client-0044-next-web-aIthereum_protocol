        ...
        <div className="w-full mt-8 p-6 rounded-lg shadow-lg space-y-6 text-white">
            <div className="flex flex-col md:flex-row justify-between items-start">
                ...
                <div className="flex flex-row gap-2">
                    ...
                    >
                        {isFavorite ? <AiFillHeart className="w-6 h-6 text-red-500"/> :
            ...
            <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {modelLinks.map(({type, previewUrl, refineUrl}) => (
                        <div key={type} className="flex items-center justify-between bg-primary-600 p-3 rounded">
                            <p className="font-medium">{type}</p>
                            <div className="flex space-x-2">
                                {previewUrl && (
                                    <a href={previewUrl} target="_blank" rel="noopener noreferrer">
                                        <button
                                            className="p-2 bg-secondary-500 text-white rounded-md flex items-center">
                                ...
                                {refineUrl && (
                                    <a href={refineUrl} target="_blank" rel="noopener noreferrer">
                                        <button
                                            className="p-2 bg-accent-500 text-black rounded-md flex items-center">
